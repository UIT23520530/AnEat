...
import CategoriesForm from "@/components/forms/admin/categories/CategoriesForm"
import CategoriesDetailModal from "@/components/forms/admin/categories/CategoriesDetailModal"
import {
  Table,
  Button,
  Input,
