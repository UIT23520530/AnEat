...
import { Search, ShoppingCart, FileText, Ticket, Split, X, Trash2, Wallet, CreditCard, Users, UserPlus } from "lucide-react"
...
const menuItems: MenuItem[] = [
  { id: "1", name: "Gà Rán Giòn", description: "2 miếng gà giòn tan", price: 45000, image: "/menu/chicken.jpg", category: "main" },
  { id: "2", name: "Burger Bò Phô Mai", description: "Burger bò 100% thịt", price: 55000, image: "/menu/burger.jpg", category: "main" },
  { id: "3", name: "Pizza Hải Sản", description: "Pizza size M", price: 89000, image: "/menu/pizza.jpg", category: "main" },
  { id: "4", name: "Khoai Tây Chiên", description: "Size vừa", price: 25000, image: "/menu/fries.jpg", category: "side" },
  { id: "5", name: "Pepsi", description: "Size M", price: 15000, image: "/menu/pepsi.jpg", category: "drink" },
  { id: "6", name: "Kem Sundae", description: "Kem vani", price: 20000, image: "/menu/ice-cream.jpg", category: "dessert" },
]
...
export default function StaffOrdersPage() {
  ...
  const [selectedCustomer, setSelectedCustomer] = useState<{ name: string; phone: string; points: number } | null>(null)
  ...
  const customers = [
    ...
    { id: "3", name: "Lê Văn C", phone: "0923456789", points: 80 },
  ]
  ...
  const handleSelectCustomer = (customer: { name: string; phone: string; points: number }) => {
                ...
                {cart.map((item) => (
                  <div key={item.id} className="flex items-start gap-3 pb-3 border-b border-gray-100">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-orange-600 font-semibold">{item.price.toLocaleString()}đ</p>
          ...
          <div className="px-4 py-3 border-t border-gray-200">
            ...
            <div className="space-y-1.5 mb-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-orange-600">{discount.toLocaleString()}đ</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">VAT (8%)</span>
                <span className="font-medium">{vat.toLocaleString()}đ</span>
              </div>
            ...
            <div className="space-y-4">
              ...
              {appliedDiscount > 0 && (
                <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                  <p className="text-sm text-green-700 font-medium">Đã áp dụng giảm giá: {appliedDiscount.toLocaleString()}đ</p>
                </div>
              )}
              <div className="flex gap-2">
                <Button
                ...
                {filteredCustomers.map((customer) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs font-medium text-orange-600">{customer.points} điểm</span>
                    </div>
                  </button>
                ))}
              </div>
