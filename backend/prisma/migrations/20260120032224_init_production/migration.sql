-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN_SYSTEM', 'ADMIN_BRAND', 'STAFF', 'CUSTOMER', 'LOGISTICS_STAFF');
...
-- CreateEnum
CREATE TYPE "TemplateCategory" AS ENUM ('SMS', 'EMAIL', 'NOTIFICATION', 'INVOICE', 'ORDER', 'RECEIPT', 'REPORT');
...
-- CreateIndex
CREATE UNIQUE INDEX "Promotion_code_branchId_key" ON "Promotion"("code", "branchId");
